...
class Journals(Resource):
    # set the collection to journals
    def __init__(self, **kwargs):
        self.db = kwargs['db']
        self.journals = self.db['journal-entries']

    # general get request to get journal(s)
    def get(self, query_category, query_key):
        # TODO: ADJUST FOR journalS
        ...
        result_cursor = self.journals.find({query_category : query_key})
        return_result = {}
